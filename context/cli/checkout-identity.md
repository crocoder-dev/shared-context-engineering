...
See also: `context/cli/agent-trace-storage.md`, `context/cli/default-path-catalog.md`, `context/cli/mutation-trace-runtime-coordinator.md` (the distinct mutation-cursor runtime lock), `context/sce/agent-trace-db.md`, `context/sce/agent-trace-hooks-command-routing.md`.
