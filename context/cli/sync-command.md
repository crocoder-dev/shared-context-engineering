...
emit the same typed runtime diagnostic with their reason and remain fail-open.
The launcher is not a daemon or retry queue; local rows remain available for a
later manual or automatic invocation through the control-plane cursor authority.
