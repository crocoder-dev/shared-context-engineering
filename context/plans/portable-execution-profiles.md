...
- [ ] T05: `Replace fixed destinations with explicit target projections` (status:todo)
  - Task ID: T05
...
- [ ] T06: `Render OpenCode profiles and native-bound workflows` (status:todo)
  - Task ID: T06
...
- [ ] T07: `Render Claude native profiles and composed workflows` (status:todo)
  - Task ID: T07
