...
- [x] T06: `Extract runtime config resolution and precedence flow` (status:done)
  - Task ID: T06
  ...
  - Files changed: `cli/src/services/config/mod.rs`, `cli/src/services/config/resolver.rs`, `cli/src/services/config/schema.rs`
