...
- [x] T04: `Sync durable context for DB-only hook persistence` (status:done)
  - Task ID: T04
  ...
  - Completed: 2026-06-29
  - Files changed: `context/overview.md`, `context/patterns.md`, `context/sce/claude-raw-hook-capture.md`, `context/plans/remove-hook-runtime-context-tmp-artifacts.md`
