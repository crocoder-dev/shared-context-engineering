...
- [ ] T05: `Implement sce trace status (current checkout) rendering` (status:todo)
  - Task ID: T05
...
- [ ] T06: `Implement sce trace status --all aggregation rendering` (status:todo)
  - Task ID: T06
...
- [ ] T08: `Validate and sync context` (status:todo)
  - Task ID: T08
