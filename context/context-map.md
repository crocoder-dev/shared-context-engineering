...
- `context/sce/agent-trace-post-commit-dual-write.md` (historical post-commit trace finalization baseline; current runtime baseline replaces this path with a deterministic no-op)
