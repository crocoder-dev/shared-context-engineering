...
- `context/sce/agent-trace-hook-doctor.md` (implemented `sce doctor` contract for default/per-repo/global hook-path rollout plus config-file and Agent Trace local DB location reporting)
