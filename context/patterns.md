...
- Do not add Flatpak CI publishing, automatic Flathub submission, prebuilt Flatpak binaries/bundles, OSTree repositories, or workflow-side release-version bumps in the current Flatpak iteration.
