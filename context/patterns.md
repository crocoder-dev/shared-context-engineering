...
- Do not add Flatpak publication beyond the approved GitHub Release source-manifest asset upload, automatic Flathub submission, prebuilt Flatpak binaries/bundles, OSTree repositories, or workflow-side release-version bumps in the current Flatpak iteration.
