...
import { formatUnsupportedPlatformMessage, getInstalledBinaryPath } from "../lib/platform.js";
...
if (!binaryPath) {
  const unsupportedMessage = formatUnsupportedPlatformMessage(process.platform, process.arch);
