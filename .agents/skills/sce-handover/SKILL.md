...
`invocation input` is optional and selects the mode:

- Empty `invocation input` selects **writer mode**.
...
For example: `$sce-handover context/handovers/2026-08-24-session.md`.
